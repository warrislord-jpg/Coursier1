...
// Point d'entrée client (coursier.app) — aucune connexion PIN, accès direct.
// Le AuthProvider reste chargé pour cohérence (fonctions inutiles ici,
// mais évite d'avoir à toucher au code partagé qui l'importe).
